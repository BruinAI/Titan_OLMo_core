class GraphModule(torch.nn.Module):
    def forward(self, primals_4: "f32[2048]", primals_5: "f32[2048]", primals_8: "f32[2048]", view: "bf16[32, 2048]", mm: "bf16[32, 2048]", pow_2: "f32[1, 1, 2048]", convert_element_type_8: "bf16[32, 2048]", mm_1: "bf16[32, 2048]", getitem_1: "f32[32, 1]", rsqrt: "f32[32, 1]", convert_element_type_14: "bf16[32, 2048]", addmm: "bf16[32, 2048]", getitem_3: "f32[32, 1]", rsqrt_1: "f32[32, 1]", permute_3: "bf16[2048, 2048]", permute_10: "bf16[2048, 2048]", permute_15: "bf16[2048, 2048]", tangents_1: "f32[1, 32, 2048]"):
        ...
        convert_element_type_18: "f32[32, 2048]" = torch.ops.prims.convert_element_type.default(addmm, torch.float32);  addmm = None
        sub_1: "f32[32, 2048]" = torch.ops.aten.sub.Tensor(convert_element_type_18, getitem_3);  convert_element_type_18 = getitem_3 = None
        ...
        convert_element_type_19: "bf16[32, 2048]" = torch.ops.prims.convert_element_type.default(mul_11, torch.bfloat16);  mul_11 = None
        mm_2: "bf16[32, 2048]" = torch.ops.aten.mm.default(convert_element_type_19, permute_3);  permute_3 = None
        permute_4: "bf16[2048, 32]" = torch.ops.aten.permute.default(convert_element_type_19, [1, 0])
        mm_3: "bf16[2048, 2048]" = torch.ops.aten.mm.default(permute_4, convert_element_type_14);  permute_4 = convert_element_type_14 = None
        sum_6: "f32[1, 2048]" = torch.ops.aten.sum.dim_IntList(convert_element_type_19, [0], True, dtype = torch.float32);  convert_element_type_19 = None
        view_3: "f32[2048]" = torch.ops.aten.reshape.default(sum_6, [2048]);  sum_6 = None
        convert_element_type_25: "f32[32, 2048]" = torch.ops.prims.convert_element_type.default(mm_2, torch.float32);  mm_2 = None
        convert_element_type_26: "f32[2048, 2048]" = torch.ops.prims.convert_element_type.default(mm_3, torch.float32);  mm_3 = None
        ...
        convert_element_type_11: "f32[32, 2048]" = torch.ops.prims.convert_element_type.default(mm_1, torch.float32);  mm_1 = None
        sub: "f32[32, 2048]" = torch.ops.aten.sub.Tensor(convert_element_type_11, getitem_1);  convert_element_type_11 = getitem_1 = None
        ...
        mul_15: "f32[32, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_25, mul_14);  convert_element_type_25 = mul_14 = None
        ...
        convert_element_type_28: "bf16[32, 2048]" = torch.ops.prims.convert_element_type.default(mul_21, torch.bfloat16);  mul_21 = None
        permute_8: "bf16[2048, 32]" = torch.ops.aten.permute.default(convert_element_type_28, [1, 0])
        mm_4: "bf16[2048, 2048]" = torch.ops.aten.mm.default(permute_8, convert_element_type_8);  permute_8 = convert_element_type_8 = None
        mm_5: "bf16[32, 2048]" = torch.ops.aten.mm.default(convert_element_type_28, permute_10);  convert_element_type_28 = permute_10 = None
        convert_element_type_33: "f32[32, 2048]" = torch.ops.prims.convert_element_type.default(mm_5, torch.float32);  mm_5 = None
        convert_element_type_34: "f32[2048, 2048]" = torch.ops.prims.convert_element_type.default(mm_4, torch.float32);  mm_4 = None
        ...
        select_scatter_default: "f32[1, 32, 2048]" = torch.ops.aten.select_scatter.default(full_default_1, convert_element_type_33, 0, 0);  full_default_1 = convert_element_type_33 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/titans/neural_memory.py:87 in <listcomp>, code: outputs = [self.mlps[i](x[i]) for i in range(x.shape[0])]
        add_6: "f32[1, 32, 2048]" = torch.ops.aten.add.Tensor(tangents_1, select_scatter_default);  tangents_1 = select_scatter_default = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/titans/neural_memory.py:490 in forward, code: queries = self.silu(self.Q(x))
        view_1: "bf16[1, 32, 2048]" = torch.ops.aten.reshape.default(mm, [1, 32, 2048]);  mm = None
        convert_element_type_4: "f32[1, 32, 2048]" = torch.ops.prims.convert_element_type.default(view_1, torch.float32)
        ...
        div: "f32[1, 32, 2048]" = torch.ops.aten.div.Tensor(convert_element_type_5, expand)
        ...
        convert_element_type_35: "bf16[1, 32, 2048]" = torch.ops.prims.convert_element_type.default(div_5, torch.bfloat16);  div_5 = None
        ...
        div_6: "f32[1, 32, 2048]" = torch.ops.aten.div.Tensor(convert_element_type_5, pow_2);  convert_element_type_5 = None
        ...
        convert_element_type_36: "bf16[1, 32, 2048]" = torch.ops.prims.convert_element_type.default(mul_24, torch.bfloat16);  mul_24 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/titans/neural_memory.py:497 in forward, code: queries = F.normalize(queries, eps=1e-8) # Normalize after convolution
        add_7: "bf16[1, 32, 2048]" = torch.ops.aten.add.Tensor(convert_element_type_35, convert_element_type_36);  convert_element_type_35 = convert_element_type_36 = None
        ...
        view_4: "bf16[32, 2048]" = torch.ops.aten.reshape.default(mul_27, [32, 2048]);  mul_27 = None
        ...
        view_5: "bf16[1, 32, 2048]" = torch.ops.aten.reshape.default(mm_7, [1, 32, 2048]);  mm_7 = None
        convert_element_type_41: "f32[1, 32, 2048]" = torch.ops.prims.convert_element_type.default(view_5, torch.float32);  view_5 = None
        convert_element_type_42: "f32[2048, 2048]" = torch.ops.prims.convert_element_type.default(mm_6, torch.float32);  mm_6 = None
        return (convert_element_type_42, convert_element_type_41, convert_element_type_34, sum_9, sum_10, convert_element_type_26, view_3, sum_4, sum_5)
