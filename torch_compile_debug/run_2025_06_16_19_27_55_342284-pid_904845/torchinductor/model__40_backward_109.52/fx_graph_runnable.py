...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_4, primals_5, primals_8, view, mm, pow_2, convert_element_type_8, mm_1, getitem_1, rsqrt, convert_element_type_14, addmm, getitem_3, rsqrt_1, permute_3, permute_10, permute_15, tangents_1):
        ...
        convert_element_type_18 = torch.ops.prims.convert_element_type.default(addmm, torch.float32);  addmm = None
        sub_1 = torch.ops.aten.sub.Tensor(convert_element_type_18, getitem_3);  convert_element_type_18 = getitem_3 = None
        ...
        convert_element_type_19 = torch.ops.prims.convert_element_type.default(mul_11, torch.bfloat16);  mul_11 = None
        mm_2 = torch.ops.aten.mm.default(convert_element_type_19, permute_3);  permute_3 = None
        permute_4 = torch.ops.aten.permute.default(convert_element_type_19, [1, 0])
        mm_3 = torch.ops.aten.mm.default(permute_4, convert_element_type_14);  permute_4 = convert_element_type_14 = None
        sum_6 = torch.ops.aten.sum.dim_IntList(convert_element_type_19, [0], True, dtype = torch.float32);  convert_element_type_19 = None
        view_3 = torch.ops.aten.view.default(sum_6, [2048]);  sum_6 = None
        convert_element_type_25 = torch.ops.prims.convert_element_type.default(mm_2, torch.float32);  mm_2 = None
        convert_element_type_26 = torch.ops.prims.convert_element_type.default(mm_3, torch.float32);  mm_3 = None
        ...
        convert_element_type_11 = torch.ops.prims.convert_element_type.default(mm_1, torch.float32);  mm_1 = None
        sub = torch.ops.aten.sub.Tensor(convert_element_type_11, getitem_1);  convert_element_type_11 = getitem_1 = None
        ...
        mul_15 = torch.ops.aten.mul.Tensor(convert_element_type_25, mul_14);  convert_element_type_25 = mul_14 = None
        ...
        convert_element_type_28 = torch.ops.prims.convert_element_type.default(mul_21, torch.bfloat16);  mul_21 = None
        permute_8 = torch.ops.aten.permute.default(convert_element_type_28, [1, 0])
        mm_4 = torch.ops.aten.mm.default(permute_8, convert_element_type_8);  permute_8 = convert_element_type_8 = None
        mm_5 = torch.ops.aten.mm.default(convert_element_type_28, permute_10);  convert_element_type_28 = permute_10 = None
        convert_element_type_33 = torch.ops.prims.convert_element_type.default(mm_5, torch.float32);  mm_5 = None
        convert_element_type_34 = torch.ops.prims.convert_element_type.default(mm_4, torch.float32);  mm_4 = None
        ...
        select_scatter = torch.ops.aten.select_scatter.default(full_default_1, convert_element_type_33, 0, 0);  full_default_1 = convert_element_type_33 = None
        ...
        convert_element_type_4 = torch.ops.prims.convert_element_type.default(view_1, torch.float32)
        ...
        div = torch.ops.aten.div.Tensor(convert_element_type_5, expand)
        ...
        convert_element_type_35 = torch.ops.prims.convert_element_type.default(div_5, torch.bfloat16);  div_5 = None
        ...
        div_6 = torch.ops.aten.div.Tensor(convert_element_type_5, pow_2);  convert_element_type_5 = None
        ...
        convert_element_type_36 = torch.ops.prims.convert_element_type.default(mul_24, torch.bfloat16);  mul_24 = None
        add_7 = torch.ops.aten.add.Tensor(convert_element_type_35, convert_element_type_36);  convert_element_type_35 = convert_element_type_36 = None
        ...
        convert_element_type_41 = torch.ops.prims.convert_element_type.default(view_5, torch.float32);  view_5 = None
        convert_element_type_42 = torch.ops.prims.convert_element_type.default(mm_6, torch.float32);  mm_6 = None
...
def load_args(reader):
    ...
    buf3 = reader.storage(None, 131072, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    ...
    reader.tensor(buf6, (32, 2048), dtype=torch.bfloat16, is_leaf=True)  # convert_element_type_8
    ...
    reader.tensor(buf10, (32, 2048), dtype=torch.bfloat16, is_leaf=True)  # convert_element_type_14
