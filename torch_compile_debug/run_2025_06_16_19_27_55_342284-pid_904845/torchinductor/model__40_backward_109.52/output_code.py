...
#   input_5 => convert_element_type_18, mul_4, sub_1
# Graph fragment:
...
#   %convert_element_type_18 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%addmm, torch.float32), kwargs = {})
...
#   %convert_element_type_19 : [num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_11, torch.bfloat16), kwargs = {})
...
# kernel path: /tmp/torchinductor_karen/ek/cekmjgpcvbbysrcyzss4w3ak2b47l766nomolmlqxvbfaqmiltbb.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
# Graph fragment:
#   %sum_6 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%convert_element_type_19, [0], True), kwargs = {dtype: torch.float32})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_sum_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': '845BD750D40B8118FA308A2BADCFC77F52F612CF9AC4B9D320C19C4934EE1026', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /tmp/torchinductor_karen/rc/crcanmmfac2kizaowsmdk3tok3f2wbqq7cibjzrpwzgdwtsznj4d.py
...
# Source node to ATen node mapping:
#   input_2 => add_1, convert_element_type_11, mul_1, mul_2, sub
#   input_3 => sigmoid_1
# Graph fragment:
#   %convert_element_type_25 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
...
#   %convert_element_type_11 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_1, torch.float32), kwargs = {})
...
#   %mul_15 : [num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_25, %mul_14), kwargs = {})
...
#   %convert_element_type_28 : [num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_21, torch.bfloat16), kwargs = {})
triton_red_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_2 = async_compile.triton('triton_red_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_2', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 10, 'num_reduction': 2, 'backend_hash': '845BD750D40B8118FA308A2BADCFC77F52F612CF9AC4B9D320C19C4934EE1026', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_red_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_2(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 32
    rnumel = 2048
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:, None]
...
# kernel path: /tmp/torchinductor_karen/g7/cg7ve6cpzqgs6irnz2ss6utcgn2qwtz57vihs7gcpqbbwkcsaisb.py
# Topologically Sorted Source Nodes: [input_2, input_3], Original ATen: [aten._to_copy, aten.fill, aten.native_layer_norm, aten.silu, aten.sub, aten.mul, aten.add, aten.native_layer_norm_backward]
# Source node to ATen node mapping:
#   input_2 => convert_element_type_11, mul_1, sub
#   input_3 => sigmoid_1
# Graph fragment:
#   %convert_element_type_25 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_2, torch.float32), kwargs = {})
#   %full_default : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([32, 2048], 1), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_3 = async_compile.triton('triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_3', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_3', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 2, 'backend_hash': '845BD750D40B8118FA308A2BADCFC77F52F612CF9AC4B9D320C19C4934EE1026', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 2048
    rnumel = 32
    RBLOCK: tl.constexpr = 32
    xoffset = tl.program_id(0) * XBLOCK
...
# Source node to ATen node mapping:
# Graph fragment:
#   %convert_element_type_26 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_3, torch.float32), kwargs = {})
...
# kernel path: /tmp/torchinductor_karen/su/csubfzf4mgvk6urmjydgsih4aw6pvtahvwb35jhjpqiumdw2yd4g.py
...
#   %convert_element_type_33 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_5, torch.float32), kwargs = {})
...
#   %select_scatter_default : [num_users=1] = call_function[target=torch.ops.aten.select_scatter.default](args = (%full_default_1, %convert_element_type_33, 0, 0), kwargs = {})
...
#   %div : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_5, %expand), kwargs = {})
...
triton_per_fused__to_copy_add_div_mul_native_layer_norm_native_layer_norm_backward_neg_select_backward_silu_sum_5 = async_compile.triton('triton_per_fused__to_copy_add_div_mul_native_layer_norm_native_layer_norm_backward_neg_select_backward_silu_sum_5', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_div_mul_native_layer_norm_native_layer_norm_backward_neg_select_backward_silu_sum_5', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 7, 'num_reduction': 3, 'backend_hash': '845BD750D40B8118FA308A2BADCFC77F52F612CF9AC4B9D320C19C4934EE1026', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_per_fused__to_copy_add_div_mul_native_layer_norm_native_layer_norm_backward_neg_select_backward_silu_sum_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 2048
    rnumel = 32
    RBLOCK: tl.constexpr = 32
    xoffset = tl.program_id(0) * XBLOCK
...
#   %convert_element_type_35 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div_5, torch.bfloat16), kwargs = {})
...
#   %div_6 : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_5, %pow_2), kwargs = {})
...
#   %convert_element_type_36 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_24, torch.bfloat16), kwargs = {})
#   %add_7 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_35, %convert_element_type_36), kwargs = {})
...
# kernel path: /tmp/torchinductor_karen/vw/cvwrsapge4xngh4ehi2h6aahrdx6q7zevz2zmnwcndlr4g6xf3lj.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
# Graph fragment:
#   %convert_element_type_41 : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_5, torch.float32), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=84, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_7', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '845BD750D40B8118FA308A2BADCFC77F52F612CF9AC4B9D320C19C4934EE1026', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
def call(args):
    primals_4, primals_5, primals_8, view, mm, pow_2, convert_element_type_8, mm_1, getitem_1, rsqrt, convert_element_type_14, addmm, getitem_3, rsqrt_1, permute_3, permute_10, permute_15, tangents_1 = args
    args.clear()
    ...
    assert_size_stride(convert_element_type_8, (32, 2048), (2048, 1))
    assert_size_stride(mm_1, (32, 2048), (2048, 1))
    assert_size_stride(getitem_1, (32, 1), (1, 1))
    assert_size_stride(rsqrt, (32, 1), (1, 1))
    assert_size_stride(convert_element_type_14, (32, 2048), (2048, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf4, (2048, 32), (1, 2048), 0), convert_element_type_14, out=buf6)
        del convert_element_type_14
        buf7 = empty_strided_cuda((1, 2048), (2048, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
        stream0 = get_raw_stream(0)
        triton_per_fused_sum_1.run(buf4, buf7, 2048, 32, grid=grid(2048), stream=stream0)
        buf9 = empty_strided_cuda((32, 2048), (2048, 1), torch.float32)
        buf14 = buf4; del buf4  # reuse
        # Topologically Sorted Source Nodes: [input_2, input_3], Original ATen: [aten._to_copy, aten.fill, aten.native_layer_norm, aten.silu, aten.sub, aten.mul, aten.add, aten.native_layer_norm_backward]
        stream0 = get_raw_stream(0)
        triton_red_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_2.run(mm_1, getitem_1, rsqrt, primals_4, primals_5, buf5, buf9, buf14, 32, 2048, grid=grid(32), stream=stream0)
        del primals_4
        del primals_5
        ...
        # Topologically Sorted Source Nodes: [input_2, input_3], Original ATen: [aten._to_copy, aten.fill, aten.native_layer_norm, aten.silu, aten.sub, aten.mul, aten.add, aten.native_layer_norm_backward]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_fill_mul_native_layer_norm_native_layer_norm_backward_silu_sub_3.run(buf5, buf9, mm_1, getitem_1, rsqrt, buf12, buf13, 2048, 32, grid=grid(2048), stream=stream0)
        del getitem_1
        del mm_1
        del rsqrt
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf14, (2048, 32), (1, 2048), 0), convert_element_type_8, out=buf15)
        ...
        # Topologically Sorted Source Nodes: [input_5, queries, queries_1], Original ATen: [aten._to_copy, aten.native_layer_norm, aten.native_layer_norm_backward, aten.select_backward, aten.add, aten.silu, aten.div, aten.neg, aten.mul, aten.sum]
        stream0 = get_raw_stream(0)
        triton_per_fused__to_copy_add_div_mul_native_layer_norm_native_layer_norm_backward_neg_select_backward_silu_sum_5.run(tangents_1, addmm, getitem_3, rsqrt_1, buf16, mm, pow_2, buf2, buf3, buf18, 2048, 32, grid=grid(2048), stream=stream0)
        del addmm
        del getitem_3
        del rsqrt_1
        ...
        del buf19
        del permute_15
        buf23 = empty_strided_cuda((2048, 2048), (2048, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_4.run(buf20, buf23, 4194304, grid=grid(4194304), stream=stream0)
        del buf20
        buf22 = reinterpret_tensor(buf9, (1, 32, 2048), (65536, 2048, 1), 0); del buf9  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_7.run(buf21, buf22, 65536, grid=grid(65536), stream=stream0)
        del buf21
    return (buf23, buf22, buf17, buf12, buf13, buf8, reinterpret_tensor(buf7, (2048, ), (1, ), 0), buf2, buf3, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    convert_element_type_8 = rand_strided((32, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    convert_element_type_14 = rand_strided((32, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    fn = lambda: call([primals_4, primals_5, primals_8, view, mm, pow_2, convert_element_type_8, mm_1, getitem_1, rsqrt, convert_element_type_14, addmm, getitem_3, rsqrt_1, permute_3, permute_10, permute_15, tangents_1])
