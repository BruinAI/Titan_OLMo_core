class GraphModule(torch.nn.Module):
    def forward(self, primals_5: "bf16[2048]", primals_6: "bf16[2048]", primals_7: "f32[128, 128]", primals_8: "f32[128, 128]", primals_10: "bf16[2048]", primals_14: "bf16[2048]", view: "bf16[128, 2048]", mm: "bf16[128, 2048]", mm_1: "bf16[128, 2048]", rsqrt: "f32[1, 128, 1]", rsqrt_1: "f32[1, 128, 1]", view_8: "bf16[1, 128, 16, 128]", convert_element_type_14: "bf16[1, 128, 16, 128]", convert_element_type_15: "bf16[1, 128, 16, 128]", getitem_4: "bf16[1, 128, 16, 128]", getitem_5: "f32[1, 16, 128]", getitem_7: "i64[2]", mm_3: "bf16[128, 2048]", rsqrt_2: "f32[1, 128, 1]", view_14: "bf16[128, 2048]", mm_4: "bf16[128, 8192]", mm_5: "bf16[128, 8192]", view_18: "bf16[128, 8192]", mm_6: "bf16[128, 2048]", rsqrt_3: "f32[1, 128, 1]", permute_9: "bf16[2048, 8192]", permute_13: "bf16[8192, 2048]", permute_18: "bf16[8192, 2048]", permute_22: "bf16[2048, 2048]", permute_30: "bf16[2048, 2048]", permute_34: "bf16[2048, 2048]", permute_38: "bf16[2048, 2048]", tangents_1: "bf16[1, 128, 2048]"):
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:214 in forward, code: return x.to(og_dtype)
        convert_element_type_32: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(tangents_1, torch.float32)
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        convert_element_type_30: "f32[2048]" = torch.ops.prims.convert_element_type.default(primals_14, torch.float32);  primals_14 = None
        mul_14: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_32, convert_element_type_30);  convert_element_type_30 = None
        ...
        view_19: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_6, [1, 128, 2048]);  mm_6 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_29: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(view_19, torch.float32);  view_19 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_12: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_29, rsqrt_3)
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        mul_15: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_32, mul_12);  convert_element_type_32 = mul_12 = None
        sum_1: "f32[1, 1, 2048]" = torch.ops.aten.sum.dim_IntList(mul_15, [0, 1], True, dtype = torch.float32);  mul_15 = None
        view_20: "f32[2048]" = torch.ops.aten.view.default(sum_1, [2048]);  sum_1 = None
        convert_element_type_33: "bf16[2048]" = torch.ops.prims.convert_element_type.default(view_20, torch.bfloat16);  view_20 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_16: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(mul_14, convert_element_type_29)
        ...
        pow_6: "f32[1, 128, 2048]" = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_29, 1.0);  convert_element_type_29 = None
        ...
        add_8: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(mul_17, mul_21);  mul_17 = mul_21 = None
         ...
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_34: "bf16[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(add_8, torch.bfloat16);  add_8 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/feed_forward.py:128 in forward, code: return self.w2(F.silu(self.w1(x)) * self.w3(x))
        view_21: "bf16[128, 2048]" = torch.ops.aten.view.default(convert_element_type_34, [128, 2048]);  convert_element_type_34 = None
        ...
        view_22: "bf16[1, 128, 8192]" = torch.ops.aten.view.default(mm_8, [1, 128, 8192]);  mm_8 = None
        view_15: "bf16[1, 128, 8192]" = torch.ops.aten.view.default(mm_4, [1, 128, 8192]);  mm_4 = None
        convert_element_type_23: "f32[1, 128, 8192]" = torch.ops.prims.convert_element_type.default(view_15, torch.float32)
        sigmoid: "f32[1, 128, 8192]" = torch.ops.aten.sigmoid.default(convert_element_type_23)
        mul_10: "f32[1, 128, 8192]" = torch.ops.aten.mul.Tensor(convert_element_type_23, sigmoid);  convert_element_type_23 = sigmoid = None
        convert_element_type_24: "bf16[1, 128, 8192]" = torch.ops.prims.convert_element_type.default(mul_10, torch.bfloat16);  mul_10 = None
        mul_22: "bf16[1, 128, 8192]" = torch.ops.aten.mul.Tensor(view_22, convert_element_type_24);  convert_element_type_24 = None
        view_17: "bf16[1, 128, 8192]" = torch.ops.aten.view.default(mm_5, [1, 128, 8192]);  mm_5 = None
        mul_23: "bf16[1, 128, 8192]" = torch.ops.aten.mul.Tensor(view_22, view_17);  view_22 = view_17 = None
        view_23: "bf16[128, 8192]" = torch.ops.aten.view.default(mul_22, [128, 8192]);  mul_22 = None
        ...
        view_24: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_10, [1, 128, 2048]);  mm_10 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/feed_forward.py:128 in forward, code: return self.w2(F.silu(self.w1(x)) * self.w3(x))
        add_9: "bf16[1, 128, 2048]" = torch.ops.aten.add.Tensor(tangents_1, view_24);  tangents_1 = view_24 = None
        ...
        view_25: "bf16[128, 8192]" = torch.ops.aten.view.default(mul_26, [128, 8192]);  mul_26 = None
        ...
        view_26: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_12, [1, 128, 2048]);  mm_12 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/feed_forward.py:128 in forward, code: return self.w2(F.silu(self.w1(x)) * self.w3(x))
        add_11: "bf16[1, 128, 2048]" = torch.ops.aten.add.Tensor(add_9, view_26);  add_9 = view_26 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:214 in forward, code: return x.to(og_dtype)
        convert_element_type_47: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(add_11, torch.float32)
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        convert_element_type_19: "f32[2048]" = torch.ops.prims.convert_element_type.default(primals_10, torch.float32);  primals_10 = None
        mul_27: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_47, convert_element_type_19);  convert_element_type_19 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:549 in forward, code: return self.w_out(att)
        view_13: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_3, [1, 128, 2048]);  mm_3 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_18: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(view_13, torch.float32);  view_13 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_8: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_18, rsqrt_2)
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        mul_28: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_47, mul_8);  convert_element_type_47 = mul_8 = None
        sum_3: "f32[1, 1, 2048]" = torch.ops.aten.sum.dim_IntList(mul_28, [0, 1], True, dtype = torch.float32);  mul_28 = None
        view_27: "f32[2048]" = torch.ops.aten.view.default(sum_3, [2048]);  sum_3 = None
        convert_element_type_48: "bf16[2048]" = torch.ops.prims.convert_element_type.default(view_27, torch.bfloat16);  view_27 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_29: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(mul_27, convert_element_type_18)
        ...
        pow_8: "f32[1, 128, 2048]" = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_18, 1.0);  convert_element_type_18 = None
        ...
        add_12: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(mul_30, mul_34);  mul_30 = mul_34 = None
         ...
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_49: "bf16[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(add_12, torch.bfloat16);  add_12 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:549 in forward, code: return self.w_out(att)
        view_28: "bf16[128, 2048]" = torch.ops.aten.view.default(convert_element_type_49, [128, 2048]);  convert_element_type_49 = None
        ...
        view_11: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(getitem_4, [1, 128, -1])
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:549 in forward, code: return self.w_out(att)
        view_12: "bf16[128, 2048]" = torch.ops.aten.view.default(view_11, [128, 2048]);  view_11 = None
        ...
        view_29: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_14, [1, 128, 2048]);  mm_14 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:546 in forward, code: att = att.view(B, T, -1)
        view_30: "bf16[1, 128, 16, 128]" = torch.ops.aten.view.default(view_29, [1, 128, 16, 128]);  view_29 = None
        ...
        getitem_9: "bf16[1, 128, 16, 128]" = auto_functionalized_v2[1]
        getitem_10: "bf16[1, 128, 16, 128]" = auto_functionalized_v2[2]
        getitem_11: "bf16[1, 128, 16, 128]" = auto_functionalized_v2[3];  auto_functionalized_v2 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/rope.py:290 in forward, code: return q_.type_as(q), k_.type_as(k)
        convert_element_type_54: "f32[1, 128, 16, 128]" = torch.ops.prims.convert_element_type.default(getitem_10, torch.float32);  getitem_10 = None
        convert_element_type_55: "f32[1, 128, 16, 128]" = torch.ops.prims.convert_element_type.default(getitem_9, torch.float32);  getitem_9 = None
        ...
        mul_35: "f32[1, 128, 16, 128]" = torch.ops.aten.mul.Tensor(convert_element_type_54, unsqueeze_1)
        ...
        unsqueeze_3: "f32[1, 128, 1, 128]" = torch.ops.aten.unsqueeze.default(unsqueeze_2, 2);  unsqueeze_2 = None
         ...
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/rope.py:227 in _apply_rotary_pos_emb, code: return ((t * pos_cos) + (self._rotate_half(t) * pos_sin)).to(t.dtype)
        mul_36: "f32[1, 128, 16, 128]" = torch.ops.aten.mul.Tensor(convert_element_type_54, unsqueeze_3);  convert_element_type_54 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/rope.py:227 in _apply_rotary_pos_emb, code: return ((t * pos_cos) + (self._rotate_half(t) * pos_sin)).to(t.dtype)
        add_13: "f32[1, 128, 16, 128]" = torch.ops.aten.add.Tensor(cat_2, mul_36);  cat_2 = mul_36 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/rope.py:227 in _apply_rotary_pos_emb, code: return ((t * pos_cos) + (self._rotate_half(t) * pos_sin)).to(t.dtype)
        mul_37: "f32[1, 128, 16, 128]" = torch.ops.aten.mul.Tensor(convert_element_type_55, unsqueeze_1);  unsqueeze_1 = None
        ...
        cat_3: "f32[1, 128, 16, 128]" = torch.ops.aten.cat.default([slice_12, neg_3], 3);  slice_12 = neg_3 = None
         ...
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/rope.py:227 in _apply_rotary_pos_emb, code: return ((t * pos_cos) + (self._rotate_half(t) * pos_sin)).to(t.dtype)
        mul_38: "f32[1, 128, 16, 128]" = torch.ops.aten.mul.Tensor(convert_element_type_55, unsqueeze_3);  convert_element_type_55 = unsqueeze_3 = None
        ...
        convert_element_type_56: "bf16[1, 128, 16, 128]" = torch.ops.prims.convert_element_type.default(add_13, torch.bfloat16);  add_13 = None
        convert_element_type_57: "bf16[1, 128, 16, 128]" = torch.ops.prims.convert_element_type.default(add_14, torch.bfloat16);  add_14 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:513 in forward, code: k = k.view(B, T, -1, self.head_dim)
        view_36: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(convert_element_type_56, [1, 128, 2048]);  convert_element_type_56 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:511 in forward, code: q = q.view(B, T, -1, self.head_dim)
        view_37: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(convert_element_type_57, [1, 128, 2048]);  convert_element_type_57 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:214 in forward, code: return x.to(og_dtype)
        convert_element_type_58: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(view_36, torch.float32);  view_36 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        convert_element_type_10: "f32[2048]" = torch.ops.prims.convert_element_type.default(primals_6, torch.float32);  primals_6 = None
        mul_39: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_58, convert_element_type_10);  convert_element_type_10 = None
        ...
        view_3: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_1, [1, 128, 2048]);  mm_1 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_9: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(view_3, torch.float32);  view_3 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_2: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_9, rsqrt_1)
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        mul_40: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_58, mul_2);  convert_element_type_58 = mul_2 = None
        sum_5: "f32[1, 1, 2048]" = torch.ops.aten.sum.dim_IntList(mul_40, [0, 1], True, dtype = torch.float32);  mul_40 = None
        view_38: "f32[2048]" = torch.ops.aten.view.default(sum_5, [2048]);  sum_5 = None
        convert_element_type_59: "bf16[2048]" = torch.ops.prims.convert_element_type.default(view_38, torch.bfloat16);  view_38 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_41: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(mul_39, convert_element_type_9)
        ...
        pow_10: "f32[1, 128, 2048]" = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_9, 1.0);  convert_element_type_9 = None
        ...
        add_15: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(mul_42, mul_46);  mul_42 = mul_46 = None
         ...
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_60: "bf16[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(add_15, torch.bfloat16);  add_15 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:214 in forward, code: return x.to(og_dtype)
        convert_element_type_61: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(view_37, torch.float32);  view_37 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        convert_element_type_7: "f32[2048]" = torch.ops.prims.convert_element_type.default(primals_5, torch.float32);  primals_5 = None
        mul_47: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_61, convert_element_type_7);  convert_element_type_7 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        view_1: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm, [1, 128, 2048]);  mm = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_6: "f32[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(view_1, torch.float32);  view_1 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_6, rsqrt)
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:212 in forward, code: x = self.weight.type_as(x) * x
        mul_48: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(convert_element_type_61, mul);  convert_element_type_61 = mul = None
        sum_7: "f32[1, 1, 2048]" = torch.ops.aten.sum.dim_IntList(mul_48, [0, 1], True, dtype = torch.float32);  mul_48 = None
        view_39: "f32[2048]" = torch.ops.aten.view.default(sum_7, [2048]);  sum_7 = None
        convert_element_type_62: "bf16[2048]" = torch.ops.prims.convert_element_type.default(view_39, torch.bfloat16);  view_39 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:206 in forward, code: x = x * torch.rsqrt(variance + self.eps)
        mul_49: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(mul_47, convert_element_type_6)
        ...
        pow_12: "f32[1, 128, 2048]" = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_6, 1.0);  convert_element_type_6 = None
        ...
        add_16: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(mul_50, mul_54);  mul_50 = mul_54 = None
         ...
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/layer_norm.py:203 in forward, code: x = x.float()
        convert_element_type_63: "bf16[1, 128, 2048]" = torch.ops.prims.convert_element_type.default(add_16, torch.bfloat16);  add_16 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        view_41: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(getitem_11, [1, 128, 2048]);  getitem_11 = None
        view_42: "bf16[128, 2048]" = torch.ops.aten.view.default(view_41, [128, 2048]);  view_41 = None
        ...
        view_45: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_16, [1, 128, 2048]);  mm_16 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        add_17: "bf16[1, 128, 2048]" = torch.ops.aten.add.Tensor(add_11, view_45);  add_11 = view_45 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        view_46: "bf16[128, 2048]" = torch.ops.aten.view.default(convert_element_type_60, [128, 2048]);  convert_element_type_60 = None
        ...
        view_47: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_18, [1, 128, 2048]);  mm_18 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        add_18: "bf16[1, 128, 2048]" = torch.ops.aten.add.Tensor(add_17, view_47);  add_17 = view_47 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        view_48: "bf16[128, 2048]" = torch.ops.aten.view.default(convert_element_type_63, [128, 2048]);  convert_element_type_63 = None
        ...
        view_49: "bf16[1, 128, 2048]" = torch.ops.aten.view.default(mm_20, [1, 128, 2048]);  mm_20 = None
        
         # File: /ssd/karen/Titan_OLMo_core/src/olmo_core/nn/attention/__init__.py:496 in forward, code: q, k, v = self.w_q(x), self.w_k(x), self.w_v(x)
        add_19: "bf16[1, 128, 2048]" = torch.ops.aten.add.Tensor(add_18, view_49);  add_18 = view_49 = None
