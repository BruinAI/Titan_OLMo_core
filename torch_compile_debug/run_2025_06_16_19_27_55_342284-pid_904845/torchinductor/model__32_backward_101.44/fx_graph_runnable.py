...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_5, primals_6, primals_7, primals_8, primals_10, primals_14, view, mm, mm_1, rsqrt, rsqrt_1, view_8, convert_element_type_17, convert_element_type_18, getitem_4, getitem_5, getitem_7, mm_3, rsqrt_2, view_14, mm_4, mm_5, view_18, mm_6, rsqrt_3, permute_9, permute_13, permute_18, permute_22, permute_30, permute_34, permute_38, tangents_1):
        convert_element_type_default_1 = torch.ops.prims.convert_element_type.default(tangents_1, torch.float32)
        convert_element_type_35 = torch.ops.prims.convert_element_type.default(primals_14, torch.float32);  primals_14 = None
        mul_14 = torch.ops.aten.mul.Tensor(convert_element_type_default_1, convert_element_type_35);  convert_element_type_35 = None
        view_19 = torch.ops.aten.view.default(mm_6, [1, 128, 2048]);  mm_6 = None
        convert_element_type_34 = torch.ops.prims.convert_element_type.default(view_19, torch.float32);  view_19 = None
        mul_12 = torch.ops.aten.mul.Tensor(convert_element_type_34, rsqrt_3)
        mul_15 = torch.ops.aten.mul.Tensor(convert_element_type_default_1, mul_12);  convert_element_type_default_1 = mul_12 = None
        ...
        convert_element_type_39 = torch.ops.prims.convert_element_type.default(view_20, torch.bfloat16);  view_20 = None
        mul_16 = torch.ops.aten.mul.Tensor(mul_14, convert_element_type_34)
        ...
        pow_6 = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_34, 1.0);  convert_element_type_34 = None
        ...
        convert_element_type_40 = torch.ops.prims.convert_element_type.default(add_8, torch.bfloat16);  add_8 = None
        view_21 = torch.ops.aten.view.default(convert_element_type_40, [128, 2048]);  convert_element_type_40 = None
        ...
        convert_element_type_27 = torch.ops.prims.convert_element_type.default(view_15, torch.float32)
        sigmoid = torch.ops.aten.sigmoid.default(convert_element_type_27)
        mul_10 = torch.ops.aten.mul.Tensor(convert_element_type_27, sigmoid);  convert_element_type_27 = sigmoid = None
        convert_element_type_28 = torch.ops.prims.convert_element_type.default(mul_10, torch.bfloat16);  mul_10 = None
        mul_22 = torch.ops.aten.mul.Tensor(view_22, convert_element_type_28);  convert_element_type_28 = None
        ...
        convert_element_type_49 = torch.ops.prims.convert_element_type.default(view_24, torch.float32);  view_24 = None
        add_9 = torch.ops.aten.add.Tensor(tangents_1, convert_element_type_49);  tangents_1 = convert_element_type_49 = None
        ...
        convert_element_type_54 = torch.ops.prims.convert_element_type.default(view_26, torch.float32);  view_26 = None
        add_11 = torch.ops.aten.add.Tensor(add_9, convert_element_type_54);  add_9 = convert_element_type_54 = None
        convert_element_type_default = torch.ops.prims.convert_element_type.default(add_11, torch.float32)
        convert_element_type_22 = torch.ops.prims.convert_element_type.default(primals_10, torch.float32);  primals_10 = None
        mul_27 = torch.ops.aten.mul.Tensor(convert_element_type_default, convert_element_type_22);  convert_element_type_22 = None
        ...
        mul_8 = torch.ops.aten.mul.Tensor(convert_element_type_21, rsqrt_2)
        mul_28 = torch.ops.aten.mul.Tensor(convert_element_type_default, mul_8);  convert_element_type_default = mul_8 = None
        ...
        convert_element_type_57 = torch.ops.prims.convert_element_type.default(view_27, torch.bfloat16);  view_27 = None
        mul_29 = torch.ops.aten.mul.Tensor(mul_27, convert_element_type_21)
        ...
        pow_8 = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_21, 1.0);  convert_element_type_21 = None
        ...
        convert_element_type_58 = torch.ops.prims.convert_element_type.default(add_12, torch.bfloat16);  add_12 = None
        view_28 = torch.ops.aten.view.default(convert_element_type_58, [128, 2048]);  convert_element_type_58 = None
        ...
        auto_functionalized_v2 = torch.ops.higher_order.auto_functionalized_v2(torch.ops.flash_attn._flash_attn_backward.default, dout = view_30, q = convert_element_type_17, k = convert_element_type_18, v = view_8, out = getitem_4, softmax_lse = getitem_5, dropout_p = 0.0, softmax_scale = 0.08838834764831845, causal = True, window_size_left = 64, window_size_right = 0, softcap = 0.0, alibi_slopes = None, deterministic = False, rng_state = getitem_7, _dq_base_index = 0, _dk_base_index = 1, _dv_base_index = 2, _all_bases = [permute_24, permute_25, permute_26]);  view_30 = convert_element_type_17 = convert_element_type_18 = view_8 = getitem_4 = getitem_5 = getitem_7 = permute_24 = permute_25 = permute_26 = None
        ...
        convert_element_type_63 = torch.ops.prims.convert_element_type.default(getitem_10, torch.float32);  getitem_10 = None
        convert_element_type_64 = torch.ops.prims.convert_element_type.default(getitem_9, torch.float32);  getitem_9 = None
        ...
        mul_35 = torch.ops.aten.mul.Tensor(convert_element_type_63, unsqueeze_1)
        ...
        mul_36 = torch.ops.aten.mul.Tensor(convert_element_type_63, unsqueeze_3);  convert_element_type_63 = None
        add_13 = torch.ops.aten.add.Tensor(cat_2, mul_36);  cat_2 = mul_36 = None
        mul_37 = torch.ops.aten.mul.Tensor(convert_element_type_64, unsqueeze_1);  unsqueeze_1 = None
        ...
        mul_38 = torch.ops.aten.mul.Tensor(convert_element_type_64, unsqueeze_3);  convert_element_type_64 = unsqueeze_3 = None
        add_14 = torch.ops.aten.add.Tensor(cat_3, mul_38);  cat_3 = mul_38 = None
        convert_element_type_65 = torch.ops.prims.convert_element_type.default(add_13, torch.bfloat16);  add_13 = None
        convert_element_type_66 = torch.ops.prims.convert_element_type.default(add_14, torch.bfloat16);  add_14 = None
        view_36 = torch.ops.aten.view.default(convert_element_type_65, [1, 128, 2048]);  convert_element_type_65 = None
        view_37 = torch.ops.aten.view.default(convert_element_type_66, [1, 128, 2048]);  convert_element_type_66 = None
        convert_element_type_67 = torch.ops.prims.convert_element_type.default(view_36, torch.float32);  view_36 = None
        convert_element_type_13 = torch.ops.prims.convert_element_type.default(primals_6, torch.float32);  primals_6 = None
        mul_39 = torch.ops.aten.mul.Tensor(convert_element_type_67, convert_element_type_13);  convert_element_type_13 = None
        view_3 = torch.ops.aten.view.default(mm_1, [1, 128, 2048]);  mm_1 = None
        convert_element_type_12 = torch.ops.prims.convert_element_type.default(view_3, torch.float32);  view_3 = None
        mul_2 = torch.ops.aten.mul.Tensor(convert_element_type_12, rsqrt_1)
        mul_40 = torch.ops.aten.mul.Tensor(convert_element_type_67, mul_2);  convert_element_type_67 = mul_2 = None
        ...
        convert_element_type_68 = torch.ops.prims.convert_element_type.default(view_38, torch.bfloat16);  view_38 = None
        mul_41 = torch.ops.aten.mul.Tensor(mul_39, convert_element_type_12)
        ...
        pow_10 = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_12, 1.0);  convert_element_type_12 = None
        ...
        convert_element_type_69 = torch.ops.prims.convert_element_type.default(add_15, torch.bfloat16);  add_15 = None
        convert_element_type_70 = torch.ops.prims.convert_element_type.default(view_37, torch.float32);  view_37 = None
        convert_element_type_10 = torch.ops.prims.convert_element_type.default(primals_5, torch.float32);  primals_5 = None
        mul_47 = torch.ops.aten.mul.Tensor(convert_element_type_70, convert_element_type_10);  convert_element_type_10 = None
        view_1 = torch.ops.aten.view.default(mm, [1, 128, 2048]);  mm = None
        convert_element_type_9 = torch.ops.prims.convert_element_type.default(view_1, torch.float32);  view_1 = None
        mul = torch.ops.aten.mul.Tensor(convert_element_type_9, rsqrt)
        mul_48 = torch.ops.aten.mul.Tensor(convert_element_type_70, mul);  convert_element_type_70 = mul = None
        ...
        convert_element_type_71 = torch.ops.prims.convert_element_type.default(view_39, torch.bfloat16);  view_39 = None
        mul_49 = torch.ops.aten.mul.Tensor(mul_47, convert_element_type_9)
        ...
        pow_12 = torch.ops.aten.pow.Tensor_Scalar(convert_element_type_9, 1.0);  convert_element_type_9 = None
        ...
        convert_element_type_72 = torch.ops.prims.convert_element_type.default(add_16, torch.bfloat16);  add_16 = None
        ...
        convert_element_type_77 = torch.ops.prims.convert_element_type.default(view_45, torch.float32);  view_45 = None
        add_17 = torch.ops.aten.add.Tensor(add_11, convert_element_type_77);  add_11 = convert_element_type_77 = None
        view_46 = torch.ops.aten.view.default(convert_element_type_69, [128, 2048]);  convert_element_type_69 = None
        ...
        convert_element_type_82 = torch.ops.prims.convert_element_type.default(view_47, torch.float32);  view_47 = None
        add_18 = torch.ops.aten.add.Tensor(add_17, convert_element_type_82);  add_17 = convert_element_type_82 = None
        view_48 = torch.ops.aten.view.default(convert_element_type_72, [128, 2048]);  convert_element_type_72 = None
        ...
        convert_element_type_87 = torch.ops.prims.convert_element_type.default(view_49, torch.float32);  view_49 = None
        add_19 = torch.ops.aten.add.Tensor(add_18, convert_element_type_87);  add_18 = convert_element_type_87 = None
...
def load_args(reader):
    ...
    reader.tensor(buf12, (1, 128, 16, 128), dtype=torch.bfloat16, is_leaf=True)  # convert_element_type_17
    buf13 = reader.storage(None, 524288, device=device(type='cuda', index=0), dtype_hint=torch.bfloat16)
    reader.tensor(buf13, (1, 128, 16, 128), dtype=torch.bfloat16, is_leaf=True)  # convert_element_type_18
    ...
    buf32 = reader.storage(None, 1048576, device=device(type='cuda', index=0))
    reader.tensor(buf32, (1, 128, 2048), is_leaf=True)  # tangents_1
